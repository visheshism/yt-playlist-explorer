...
const Error = () => {
  return (
    <div className='jumbotron' style={{ backgroundColor: 'rgba(239, 102, 102, 0.4)', color: 'rgba(138, 4, 4, 0.84)', borderRadius: '6px', padding: '20px 20px', opacity: 0, animation: 'toOpacity1 2s forwards', transform: 'translateY(20px)', marginTop: '40px' }}>
