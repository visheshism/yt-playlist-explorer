...
const Welcome = () => {
    ...
    return (
        <div className='jumbotron' style={{ backgroundColor: 'rgba(98, 222, 143, 0.3)', color: 'rgba(0, 57, 21, 0.9)', borderRadius: '6px', padding: '20px 20px', opacity: 0, animation: 'toOpacity1 2s forwards', transform: 'translateY(20px)', marginTop: '40px' }}>
